...
async def logout(
    ...
    if not access_token and not refresh_token:
        return {"message": "Already logged out", "status": "no tokens"}
    ...
    # Always delete cookies, even if tokens are invalid
    ...
    if tokens_valid:
        ...
        return {"message": "Cookies cleared, but no valid tokens found", "status": "invalid_tokens"}
